...
// math-inlining.
import { abs, acos, add, atan2, bignumber, compare, cos, multiply, pow, sin, sqrt, subtract } from "mathjs";
...
const utilities = {
	...
	compute: function (t, points, _3d) {
		...
		console.log("order");
		console.log(order);
		console.log((Number(compare(order, bignumber(3)))));
		console.log((Number(compare(order, bignumber(3))) === -1));
