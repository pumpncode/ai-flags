	...
	<ul>
		{
			Object.entries(vexillologists)
				...
				.map(([vexillologistName, vexillographers]) => (
					<li key={vexillologistName} className="border border-neutral-600 border-b-0 last-child:border-b p-4 flex flex-col gap-4 first-child:rounded-t last-child:rounded-b">
